...
function Product({ title, src, discription, price, id }) {
  ...
  return (
    ...
    <div className={`grid place-content-center gap-2 max-w-[80%] transform-gpu transition-transform mx-auto p-2 min-w-[80%] my-4 bg-slate-100  shadow-2xl  ${
      ishovered ? " scale-110" : ""}`} 
      ...
      <div className="flex  w-full place-content-center gap-1">
        ...
        <button className="bg-orange-600 hover:bg-green-600 p-3 lg:px-10  rounded-lg shadow-lg text-white  "> <Link to={`/products/${id}`}>ViewItem </Link></button>
